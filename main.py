...
light_content_block = [
                        ...
                        sg.Button(image_filename='./icons/lighton.png', key='-LIGHT-1-ON', visible=False, border_width=0, button_color='black'),
                        sg.Button( image_filename='./icons/lightoff.png', key='-LIGHT-1-OFF', visible=True, border_width=0, button_color='black')],
                        # Light 2
                        [sg.Text('Light 2', font='Any 14', pad=(10, 10)),
                        sg.Button(image_filename='./icons/lighton.png', key='-LIGHT-2-ON', visible=False, border_width=0, button_color='black'),
                        sg.Button( image_filename='./icons/lightoff.png', key='-LIGHT-2-OFF', visible=True, border_width=0, button_color='black')],
                        # Light 3
                        [sg.Text('Light 3', font='Any 14', pad=(10, 10)),
                        sg.Button(image_filename='./icons/lighton.png', key='-LIGHT-3-ON', visible=False, border_width=0, button_color='black'),
                        sg.Button( image_filename='./icons/lightoff.png', key='-LIGHT-3-OFF', visible=True, border_width=0, button_color='black')]]
