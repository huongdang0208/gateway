...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _LED_T._serialized_end=91
  _SWITCH_T._serialized_start=93
  _SWITCH_T._serialized_end=157
  _COMMAND._serialized_start=160
  _COMMAND._serialized_end=313
